...
USDT 같은 스테이블코인은 사실상 \"USD 보유\"라서 환율 변동 = USDT KRW 가격 변동. 본인이 환율 비교 시 [환율 변환기](https://calai.kr/exchange)로 매매 시점 환율을 비교하는 습관 들였다.
...
### ④ 평단가 추적의 함정
업비트 \"평균 매수단가\"가 본인 실제 평단가와 다른 경우가 있음. 본인이 시장가 매수 vs 지정가 매수 섞어서 했더니 거래소 표시 평단과 본인 계산 평단이 약 1~2% 차이. [코인 평단가 계산기](https://calai.kr/coin-average)에 본인 매수 내역 직접 입력하는 게 더 정확.
...
본인 코인 매매 손익 정확히 계산하려면 [코인 손익 계산기](https://calai.kr/coin-pl)에 매수가·매도가·수량·수수료율 넣으면 즉시 산정. 매매 직전에 한 번씩 시뮬레이션하면 \"기대 수익 vs 실 수익\" 격차가 보인다.
