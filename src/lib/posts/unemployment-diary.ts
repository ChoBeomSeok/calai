...
**5) 1일 상한 66,000원**
연봉 8천이든 5천이든 동일. 평균임금 60% 가 66,000 넘으면 무조건 상한 적용. 본인 수급액 사전 시뮬레이션 [실업급여 계산기](https://calai.kr/unemployment-benefit)에서 가능.
...
권고사직 자체가 좋은 일은 아닌데, 그래도 실업급여 제도 덕분에 9개월 동안 \"먹고 자는 걱정\" 없이 자격증·재취업 준비 했다. 처음 통보받았을 때 막막했지만 절차 하나하나 밟아보니 \"국가가 6개월 정도는 보장해주는 시스템\"이라는 게 체감됐다. 본인이 비슷한 상황이면 우선 [실업급여 계산기](https://calai.kr/unemployment-benefit)에 본인 평균임금·가입기간·연령 넣고 \"몇 개월 + 얼마\"인지부터 확인하고 들어가는 게 마음이 편하다.
