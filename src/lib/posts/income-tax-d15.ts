...
[종합소득세 계산기](https://calai.kr/income-tax)에서 본인 소득 + 공제 항목 다 넣어 미리 산출세액·환급액 시뮬레이션 가능. 홈택스에서 임시저장한 신고서랑 비교해서 차이 나면 어디가 빠졌는지 역추적된다.
...
[종합소득세 계산기](https://calai.kr/income-tax)로 먼저 본인 환급액 추정 → 마음에 안 들면 동네 세무사에 임시저장본 들고 가서 빠진 공제 짚어달라 하는 게 본인 추천 순서.
