...
본인 케이스 23일 × 14.7만 = 339만 → 최종 412만. [연차·휴가 일수 계산기](https://calai.kr/annual-leave)로 본인 입사일·근속·이월 연차 정확히 산출하면 정산서 검증할 때 기준 잡힌다.
...
[연봉 실수령액 계산기](https://calai.kr/salary)에서 본인 통상임금 + 연차수당 합산 시 실수령액 시뮬레이션 가능. 퇴사 D-30 즈음 한 번 돌려보는 게 안전.
