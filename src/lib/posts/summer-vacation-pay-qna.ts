...
[연차·휴가 일수 계산기](https://www.calai.kr/annual-leave)로 본인 잔여 연차 확인 후, 회사 단체협약·취업규칙에 \"휴가비\" 조항 검색 → 정확한 본인 케이스 확인 가능.
...
[연봉 실수령액 계산기](https://www.calai.kr/salary)에서 연봉 + 휴가비 입력하면 한계세율 변화·세후 실수령 시뮬레이션 가능.
...
[연봉 실수령액 계산기](https://www.calai.kr/salary)로 휴가비 받았을 때 세후 실수령 미리 계산 → 통장 입금 액수 예측 가능.
