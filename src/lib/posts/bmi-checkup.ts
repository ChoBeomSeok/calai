...
이 4개 + BMI 5개 보고 본인 건강 종합 진단하는 게 정확. 본인 BMI는 [BMI 계산기](https://www.calai.kr/bmi)에서 확인. 표준 체중 (BMI 22 환산)도 같이 보면 본인 목표 체중 산정 가능.
...
본인 BMI 시뮬레이션은 [BMI 계산기](https://www.calai.kr/bmi)·[칼로리 계산기](https://www.calai.kr/calorie) (BMR·TDEE 계산)에서. 본인 케이스 정확히 입력하면 일일 칼로리 목표가 나오고, 거기에 -500 빼면 월 2kg 안전 감량 페이스.
