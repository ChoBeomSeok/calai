...
3가지 나이가 동시에 작동하는 셈이다. 본인 또는 가족 케이스에서 \"몇 살부터 가능?\"이 헷갈리면 [만 나이 계산기](https://www.calai.kr/age)에 생년월일 넣으면 만 나이 / 연 나이 / 한국식 나이 + 다음 생일 D-Day까지 한 번에 보인다. 위 6개 케이스도 본인 가족의 정확한 나이부터 확인하면 결정이 빠르다.
