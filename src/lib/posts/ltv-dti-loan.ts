...
3. **DSR 자체 계산** — [LTV·DSR 계산기](https://calai.kr/ltv-dti)
...
본인이 매수 검토 중이면 [LTV·DSR 계산기](https://calai.kr/ltv-dti)에 주택가·연소득·기존 대출 정확히 넣고 \"실 한도\" 먼저 확인. LTV 70%만 보지 말고 DSR 한도까지 같이 봐야 진짜 매수 가능 금액이 나온다.
