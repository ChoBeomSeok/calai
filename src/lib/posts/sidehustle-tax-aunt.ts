...
본인이 옆에서 같이 [종합소득세 계산기](https://www.calai.kr/income-tax)에 이모 작년 사업소득 + 근로소득 넣어봤다. 단순경비율 적용하면 실제 산출세액은 매년 70~110만 수준. 5월에 신고만 했어도 환급은 못 받아도 가산세 없이 끝났을 액수.
...
부업 수익 있는 분들은 [프리랜서 3.3% 원천징수 계산기](https://www.calai.kr/freelancer-tax)로 본인 원천징수액 + 신고 의무 여부 먼저 체크. 연 300만 한 번이라도 넘었으면 그 해부터 종합신고 시작이 안전.
