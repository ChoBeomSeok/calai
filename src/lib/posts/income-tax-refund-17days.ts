...
본인 케이스 시뮬레이션은 [종합소득세 계산기](https://www.calai.kr/income-tax)에 본인 사업소득·근로소득·공제 항목 넣으면 산출세액·환급액 미리 확인 가능. 추가 납부 vs 환급 여부 사전 판단.

프리랜서 본인이 받은 원천징수 액수만 따로 보고 싶으면 [프리랜서 3.3% 원천징수 계산기](https://www.calai.kr/freelancer-tax)에서 수익 입력 → 차감 액수 확인.
