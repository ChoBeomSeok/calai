...
[프리랜서 3.3% 원천징수 계산기](https://calai.kr/freelancer-tax)로 본인 원천징수액 + 예상 환급액 추정 → 차이 크면 적용 가능한 공제를 다 짚어봐야 한다.
...
수익 1,000만 이상 프리랜서는 [종합소득세 계산기](https://calai.kr/income-tax)로 본인 한계세율 + 환급 시뮬레이션 먼저, 그 후 단순경비율 vs 간편장부 비교 → 어떤 게 환급액 큰지 결정하면 된다.
