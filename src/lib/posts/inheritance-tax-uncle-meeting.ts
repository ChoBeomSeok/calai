...
본인 케이스 시뮬레이션은 [상속세 계산기](https://www.calai.kr/inheritance-tax) 에 시가·예금·부채·장례비·배우자 여부·자녀 수 넣으면 즉시 산정 나온다. 사전증여 합산까지 한 번에 잡아주니 미팅 가기 전 대략 감 잡고 가는 용도로 유용했다.
...
본인 가족 케이스 대략 산정은 [상속세 계산기](https://www.calai.kr/inheritance-tax) 에 자산·부채·배우자 여부·자녀 수 넣으면 1분 안에 나온다. 10억 이상 상속은 세무사 동행 권장 (보수 200~400만, 무신고 가산세 한 번 맞는 것보다 훨씬 저렴). 정말 어려운 건 \"공시가로 신고할까 시가로 신고할까\" 같은 판단인데, 그건 첫 미팅에서 한 시간이면 답이 잡힌다.
