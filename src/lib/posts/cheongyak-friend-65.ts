...
가점제 도전 가능 여부는 본인 현재 점수에 따라 다르다. [청약 가점 계산기](https://calai.kr/cheongyak-score)에 무주택 기간·부양가족 수·청약통장 가입 기간을 넣으면 즉시 0~84점 산정된다. 30점대면 추첨제·특별공급 도전, 50점대면 비인기 단지 가점제, 65점+면 인기 단지까지 도전 가능. 그래서 본인 점수 알면 어떤 트랙을 노릴지 결정이 빠르다.
