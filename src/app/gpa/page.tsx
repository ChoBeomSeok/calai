        ...
        <div className="space-y-2">
          {courses.map((c) => (
            <div key={c.id} className="grid grid-cols-3 gap-2">
              ...
              <input type="number"
              min="0" value={c.credit} onChange={(e) => updateCourse(c.id, "credit", parseInt(e.target.value) || 0)} className="px-3 py-2 rounded-lg border border-slate-300 focus:border-indigo-500 focus:outline-none" placeholder="학점" />
