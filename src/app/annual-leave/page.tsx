  ...
  return (
    ...
    >
      ...
      <div className="mt-8 text-sm text-slate-600 dark:text-slate-400">
        <h2 className="font-semibold text-slate-800 dark:text-slate-200 text-base mb-2">📌 근로기준법 제60조 핵심</h2>
        <ul className="list-disc list-inside space-y-1.5 text-xs">
          <li><strong>1년 미만</strong>: 매월 만근 시 월차 1일 (최대 11일) — 제60조 제2항</li>
          <li><strong>1년 이상 + 80% 출근</strong>: 연차 15일 — 제60조 제1항</li>
          <li><strong>3년차부터</strong>: 2년에 1일 가산 (3년 16·5년 17·7년 18·... 21년+ 25일 상한)</li>
          <li><strong>1년 시점 최대 26일</strong>: 1년 미만 11일 + 1년차 15일 (사용촉진 미실시 시)</li>
          <li><strong>5인 미만 사업장</strong>: 법정 의무 X — 회사 자체 규정 적용</li>
          <li><strong>80% 출근 요건</strong>: 1년 80% 미달 시 연차 0일 (만근월 월차 1일은 별도)</li>
          <li><strong>육아휴직·산재·출산휴가</strong>: 출근 간주 (제60조 제6항)</li>
          <li><strong>미사용 연차 수당</strong>: 만료 시 통상임금 × 미사용 일수 (사용촉진 미실시 시)</li>
        </ul>
      </div>
      ...
      <div className="mt-4 rounded-xl bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 p-3 text-xs text-amber-900 dark:text-amber-300">
        ⚠️ <strong>회계연도 기준 차이</strong>: 본 도구는 \"입사일 기준\" (근로기준법 표준). 회사가 \"회계연도 기준\" (1월 1일~12월 31일) 운영 시 일수가 약간 다를 수 있습니다. 단, 회계 기준이 입사일 기준보다 불리하면 안 됨 (대법원 판례).
      </div>
    </CalculatorLayout>
  );
}
