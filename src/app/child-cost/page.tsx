...
export default function ChildCostPage() {
  ...
  const result = useMemo(() => {
    ...
    const total = baby + school + teen + edu;
    return { baby, school, teen, edu, total };
  }, [babyMonthly, schoolMonthly, teenMonthly, eduExtra]);
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 sm:p-8 shadow-sm">
        ...
        <div className="mt-8 pt-6 border-t border-slate-200 dark:border-slate-700">
          <div className="rounded-xl bg-indigo-50 dark:bg-indigo-950 p-5 text-center">
            <div className="text-sm text-indigo-700 dark:text-indigo-400 mb-1">0~18세 누적 양육비</div>
